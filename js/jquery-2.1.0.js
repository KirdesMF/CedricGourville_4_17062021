/*! jQuery v2.1.0 | (c) 2005, 2014 jQuery Foundation, Inc. | jquery.org/license */ !(function (
   a,
   b
) {
                            ...
                            return d
                               ...
                               : ((d =
                                 ...
                                 (!c.sortDetached &&
                                    ...
                                    ? a === e ||
                                      (a.ownerDocument === t && r(t, a))
                                       ? -1
                                       : b === e ||
                                         (b.ownerDocument === t && r(t, b))
                                       ? 1
                                       : i
      ...
      function ub(a) {
         for (
            ...
            if ((c = d.relative[a[j].type])) m = [qb(rb(m), c)];
               ...
               if (
                  ((c = d.filter[a[j].type].apply(null, a[j].matches)), c[s])
               ) {
      ...
      function xb(a, b, e, f) {
         ...
         if (!f && 1 === m.length) {
            if (
               ...
               if (
                  ((b = (d.find.ID(j.matches[0].replace(ab, bb), b) || [])[0]),
                  !b)
               )
                  return e;
   ...
   (o.filter = function (a, b, c) {
      ...
      o.fn.extend({
         ...
         is: function (a) {
            return !!x(
               this,
               'string' == typeof a && u.test(a) ? o(a) : a || [],
               !1
            ).length;
         },
      });
            ...
            if (c[1]) {
               if (
                  ...
                  o.merge(
                     ...
                     o.parseHTML(
                        c[1],
                        b && b.nodeType ? b.ownerDocument || b : m,
                        !0
                     )
                  ),
            ...
            for (
               ...
               for (c = this[d]; c && c !== b; c = c.parentNode)
                  if (
                     ...
                     (g
                        ? g.index(c) > -1
                        : 1 === c.nodeType && o.find.matchesSelector(c, a))
                  ) {
                     f.push(c);
                     break;
                  }
      ...
      function (a, b) {
         o.fn[a] = function (c, d) {
            ...
            return (
               ...
               this.length > 1 &&
                  (C[a] || o.unique(e), B.test(a) && e.reverse()),
               this.pushStack(e)
            );
         };
      }
      ...
      (K.prototype = {
         ...
         access: function (a, b, c) {
            ...
            return void 0 === b || (b && 'string' == typeof b && void 0 === c)
               ? ((d = this.get(a, b)),
                 void 0 !== d ? d : this.get(a, o.camelCase(b)))
      ...
      trigger: function (b, c, d, e) {
         ...
         if (
            ...
            3 !== d.nodeType &&
               ...
               (b = b[o.expando]
                  ? b
                  : new o.Event(q, 'object' == typeof b && b)),
               (b.isTrigger = e ? 2 : 3),
               (b.namespace = r.join('.')),
   ...
   function nb(a, b) {
      ...
      if (1 === b.nodeType) {
         ...
         M.hasData(a) &&
            ((h = M.access(a)), (i = o.extend({}, h)), M.set(b, i));
      }
   }
   ...
   o.extend({
      ...
      cleanData: function (a) {
         for (
            var b, c, d, e, f, g, h = o.event.special, i = 0;
            void 0 !== (c = a[i]);
            i++
         ) {
            if (
               o.acceptData(c) &&
               ((f = c[L.expando]), f && (b = L.cache[f]))
            ) {
               if (((d = Object.keys(b.events || {})), d.length))
                  for (g = 0; void 0 !== (e = d[g]); g++)
                     h[e]
                        ? o.event.remove(c, e)
                        : o.removeEvent(c, e, b.handle);
      ...
      o.fn.extend({
         ...
         remove: function (a, b) {
            for (
               var c, d = a ? o.filter(a, this) : this, e = 0;
               null != (c = d[e]);
               e++
            )
         ...
         domManip: function (a, b) {
            ...
            if (
               q ||
               (k > 1 && 'string' == typeof p && !l.checkClone && eb.test(p))
            )
            ...
            if (
               ...
               if (g)
                  for (
                     i = f[f.length - 1].ownerDocument, o.map(f, lb), j = 0;
                     g > j;
                     j++
                  )
                     (h = f[j]),
      ...
      o.each(
         ...
         function (a, b) {
            o.fn[a] = function (a) {
               for (
                  var c, d = [], e = o(a), g = e.length - 1, h = 0;
                  g >= h;
                  h++
               )
   ...
   o.extend({
            ...
            return (
               ...
               void 0 === c
                  ...
                  : ((f = typeof c),
                    'string' === f &&
                       (e = Bb.exec(c)) &&
                       ((c = (e[1] + 1) * e[2] + parseFloat(o.css(a, b))),
                       (f = 'number')),
                    null != c &&
                       c === c &&
      ...
      css: function (a, b, c, d) {
         ...
         return (
            ...
            '' === c || c
               ? ((f = parseFloat(e)), c === !0 || o.isNumeric(f) ? f || 0 : e)
               : e
         );
      },
   }),
               ...
               return Gb(
                  ...
                  d
                     ? Hb(
                          ...
                          b,
                          d,
                          'border-box' === o.css(a, 'boxSizing', !1, e),
                          e
                       )
                     : 0
               );
         ...
         _default: {
            ...
            set: function (a) {
               o.fx.step[a.prop]
                  ? o.fx.step[a.prop](a)
                  : a.elem.style &&
                    (null != a.elem.style[o.cssProps[a.prop]] ||
                       o.cssHooks[a.prop])
         ...
         '*': [
            function (a, b) {
               var c = this.createTween(a, b),
                  ...
                  g =
                     (o.cssNumber[a] || ('px' !== f && +d)) &&
                     Ob.exec(o.css(c.elem, a)),
                  h = 1,
                  i = 20;
               if (g && g[3] !== f) {
                  (f = f || g[3]), (e = e || []), (g = +d || 1);
            ...
            if (a && 3 !== f && 8 !== f && 2 !== f)
               return typeof a.getAttribute === U
                  ...
                  : ((1 === f && o.isXMLDoc(a)) ||
                       ...
                       (d =
                          o.attrHooks[b] ||
                          (o.expr.match.bool.test(b) ? Zb : Yb))),
                    void 0 === c
            ...
            e = this[0];
         {
            ...
            if (e)
               return (
                  (b =
                     o.valHooks[e.type] ||
                     o.valHooks[e.nodeName.toLowerCase()]),
         ...
         valHooks: {
            select: {
                     ...
                     if (
                        ...
                        !(
                           ...
                           (c.parentNode.disabled &&
                              o.nodeName(c.parentNode, 'optgroup'))
                        ))
                     ) {
               ...
               set: function (a, b) {
                  ...
                  while (g--)
                     (d = e[g]),
                        (d.selected = o.inArray(o(d).val(), f) >= 0) &&
                           (c = !0);
   ...
   (o.offset = {
      ...
      o.each(['top', 'left'], function (a, b) {
         o.cssHooks[b] = yb(l.pixelPosition, function (a, c) {
            return c
               ? ((c = xb(a, b)), vb.test(c) ? o(a).position()[b] + 'px' : c)
               : void 0;
         });
      }),
      o.each(
   ...
   return (
      (o.noConflict = function (b) {
         return (
            a.$ === o && (a.$ = Mc), b && a.jQuery === o && (a.jQuery = Lc), o
         );
      }),
